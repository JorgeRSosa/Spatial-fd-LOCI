...
simf2<-function(t){2 + sin(t)-0.2*cos(0.5*(t-1))}
...
for (k in 1:mc) {
  ...
  Cor.mat=matern(DG2, phi=1/range(DG2)[2], kappa=3/2) ### Familia matern con factor nu = 3/2
  svdcor=svd(Cor.mat)
...
save(result,file = 'Rdata/Dependiente/Caso 1 cluster/result_cluster_matern_1.5.rdata')